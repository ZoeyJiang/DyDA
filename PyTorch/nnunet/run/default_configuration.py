...
def get_default_configuration(dataset_p,plans_file,output_folder,network, network_trainer, plans_identifier=default_plans_identifier,
    ...
    print("\nI am using data from this folder: ", dataset_p)
    print('\nOutput path is in this folder:', output_folder)
    print("###############################################")
    return plans_file, output_folder_name, dataset_p, batch_dice, stage, trainer_class
