...
# 测试集路径，命名规则按照nnUnet要求
testset_path = 'DATASET/raw/CT_tumor_kidney/kits/testset/original_all/'


model_path = 'dataset/trained_models/Task003_mixed_jph_kits/0-params/tumor_kidney/1_1/2_split_10_period/'

# 结果路径
outp = 'dataset/result/0-params/tumor_kidney/1_1/2_split_10_period/'

define_output_path = False
save_npz_for_entropy_ranking = False
load_model_in_training = False
...
def main():
    ...
    folds = args.folds
    save_npz = save_npz_for_entropy_ranking
    ...
    if load_model_in_training:
        model_name = 'model_latest'
        output_folder = join(outp, 'in_training')
    else:
        model_name = args.chk
        output_folder = outp
    ...
    input_folder = testset_path
    print("using model stored in ", model_folder_name)
    assert isdir(model_folder_name), model_folder_name

    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        num_threads_nifti_save, lowres_segmentations, part_id, num_parts, not disable_tta,
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not args.disable_mixed_precision,
                        step_size=step_size, checkpoint_name=model_name)
