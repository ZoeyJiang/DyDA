...
def get_no_augmentation_tr_only(dataloader_train, patch_size, params=default_3D_augmentation_params,
                        border_val_seg=-1,
                        seeds_train=None, seeds_val=None, order_seg=1, order_data=3, deep_supervision_scales=None,
                        soft_ds=False,
                        classes=None, pin_memory=True, regions=None):
...
# data augmentation for target_dataset
...
def get_moreDA_augmentation_tr_only(dataloader_train, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
                            seeds_train=None, seeds_val=None, order_seg=1, order_data=3, deep_supervision_scales=None,
                            soft_ds=False,
                            classes=None, pin_memory=True, regions=None):
...
# data augmentation for source_dataset and target_vali_dataset
