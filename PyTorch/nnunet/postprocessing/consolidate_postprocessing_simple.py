...
def main():
    ...
    output_folder_base = '/seu_share/home/ygy_jzy/olddata/ygy_jzy/nnUNetFrame/dataset/nnUNet_trained_models/nnUNet/3d_fullres/Task008_new_mixed_ACDC_myo_emidec/nnUNetTrainerV2__nnUNetPlansv2.1'
    output_folder_raw = '/seu_share/home/ygy_jzy/olddata/ygy_jzy/nnUNetFrame/dataset/nnUNet_trained_models/nnUNet/3d_fullres/Task008_new_mixed_ACDC_myo_emidec/nnUNetTrainerV2__nnUNetPlansv2.1/cv_niftis_raw'
    output_folder_gt = '/seu_share/home/ygy_jzy/olddata/ygy_jzy/nnUNetFrame/dataset/nnUNet_trained_models/nnUNet/3d_fullres/Task008_new_mixed_ACDC_myo_emidec/nnUNetTrainerV2__nnUNetPlansv2.1/gt_niftis'

    consolidate_folds(output_folder_base=output_folder_base, output_folder_raw=output_folder_raw,
                      output_folder_gt=output_folder_gt, advanced_postprocessing=True)
